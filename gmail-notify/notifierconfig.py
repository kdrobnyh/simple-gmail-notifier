...
sys.path[0] = "/home/kad/projects/packages/gmail_notify/trunk/gmail-notify/gmail-notify"
    ...
    def onOkay( self, widget, callback_data=None ):
        ...
        if True:#( len( errorString ) == 0 ):
            ...
            if ( not self.savePassword.get_active() ):
                ...
                if (self.options["gmailusername"] != None and self.options["gmailusername"] != ""):
                    self.options["gmailusername"] = bz2.compress(self.options["gmailusername"]).encode('base64')
                if (self.options["gmailpassword"] != None and self.options["gmailpassword"] != ""):
